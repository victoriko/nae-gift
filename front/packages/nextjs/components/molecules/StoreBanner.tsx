...
import { itemIcon, messageIcon, saleIcon } from "../../images/Icon";
...
const StoreBanner = () => {
  ...
  return (
    <div className="relative w-full">
      <Image src={giftImage4} alt="" className="w-[100%] h-[900px] mobile:h-[150px] object-cover" />
      <div className="absolute  w-full top-[80%] mx-[auto] transform -translate-y-1/2 z-10 flex flex-row justify-center gap-x-36">
        ...
        <button className="flex flex-col items-center">
          <Image src={messageIcon} alt="" className="mobile:h-[30px] mobile:w-[30px]" onClick={toggleModal} />
          <p>Message</p>
        </button>
      </div>
